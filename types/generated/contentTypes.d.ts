...
export interface ApiWorkWork extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    clientType: Schema.Attribute.Enumeration<['a', 'b', 'c']> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    data: Schema.Attribute.RichText;
    detailsData: Schema.Attribute.Component<
      'work-details-data.details-data',
      true
    > &
      Schema.Attribute.Required;
    front_landscape: Schema.Attribute.Media<'images'> &
      Schema.Attribute.Required;
    front_square: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    front_vertical: Schema.Attribute.Media<'images'> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    workType: Schema.Attribute.Enumeration<['a', 'b', 'c']> &
      Schema.Attribute.Required;
  };
}
